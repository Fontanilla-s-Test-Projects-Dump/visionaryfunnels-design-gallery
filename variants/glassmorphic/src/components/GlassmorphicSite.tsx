...
function HomePage() {
  return (
    <PageFrame links={homeNav} current="home">
      <main>
        <Hero
          eyebrow="The glass operations console"
...
function ProofSection() {
  return (
    <section id="testimonials" className="section wash-section">
      <div className="section-wrap">
        <SectionLead eyebrow="Inside the glass console" title={<>Systems that earn their <em>keep.</em></>} align="center">
  ...
  return (
    <footer className="site-footer">
      <div className="section-wrap footer-grid">
        <div><Brand /><p>The glass operating console behind a business that runs without everything routing through one person.</p></div>
