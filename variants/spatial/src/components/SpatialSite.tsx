...
function HomePage() {
  return (
    <PageFrame links={homeNav} current="home">
      <main>
        <Hero
          eyebrow="Spatial operations / context in view"
...
function ProofSection() {
  return (
    <section id="testimonials" className="section wash-section">
      <div className="section-wrap">
        <SectionLead eyebrow="The view from above" title={<>Systems that earn their <em>keep.</em></>} align="center">
  ...
  return (
    <footer className="site-footer">
      <div className="section-wrap footer-grid">
        <div><Brand /><p>The spatial operating layer behind a business that runs without everything routing through one person.</p></div>
