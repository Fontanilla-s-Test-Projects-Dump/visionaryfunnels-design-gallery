...
function HomePage() {
  return (
    <PageFrame links={homeNav} current="home">
      <main>
        <Hero
          eyebrow="Fluid systems / less drag"
...
function ProofSection() {
  return (
    <section id="testimonials" className="section wash-section">
      <div className="section-wrap">
        <SectionLead eyebrow="The flow state" title={<>Systems that earn their <em>keep.</em></>} align="center">
  ...
  return (
    <footer className="site-footer">
      <div className="section-wrap footer-grid">
        <div><Brand /><p>The fluid operating layer behind a business that runs without everything routing through one person.</p></div>
